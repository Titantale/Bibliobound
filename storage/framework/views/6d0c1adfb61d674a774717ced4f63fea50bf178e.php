        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-danger topbar mb-4 static-top shadow">
                    <!-- <div style="text-align: center; font-size: 24px; color: white;"><h2 class="text-center">Detailed Description Of Food</h2></div> -->
                    <nav class="navbar navbar-expand navbar-dark fixed-top bg-dark topbar mb-4" id="mainNav">
...
</html><?php /**PATH C:\laragon\www\sharekitpaV9\resources\views/layout/privatesingle.blade.php ENDPATH**/ ?>